            ...
            <div className="grid grid-cols-12 mx-auto gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 max-w-7xl my-10 px-2">
                <div id="menu" className="bg-base-100 col-span-3 rounded-lg p-4 ">
                    ...
                    <a href="#" className="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-5 items-center md:space-x-2 hover:bg-white/10 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
                        ...
                        <div>
                            <p className="font-medium group-hover:text-indigo-400 leading-4">Abdullah Umer</p>
                            <span className="text-xs text-slate-400">Astro LLC</span>
                        </div>
                    </a>
                    <hr className="my-2 border-slate-700"/>
                    <div id="menu" className="flex flex-col space-y-2 my-5">
                        <a href="/buyer/list" className="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                            <div className="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                                ...
                                <div>
                                    <p className="font-bold text-base lg:text-lg text-slate-200 leading-4 group-hover:text-indigo-400">List Property</p>
                                <p className="text-slate-400 text-sm hidden md:block">Add new property</p>
                                </div>
                                
                            </div>
                        </a>
                        <a href="/buyer/manage" className="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                            <div className="relative flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                                ...
                                <div>
                                    <p className="font-bold text-base lg:text-lg text-slate-200 leading-4 group-hover:text-indigo-400">Manage Property</p>
                                <p className="text-slate-400 text-sm hidden md:block">Edit/Delete Listing</p>
                                </div>
                ...
                <div id="content" className="bg-base-100 col-span-9 rounded-lg p-6">
                    <div id="24h">
                        ...
                        <div id="stats" className="grid gird-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="bg-black/30 to-white/5 p-6 rounded-lg">
                                <div className="flex flex-row space-x-4 items-center">
                                    ...
                                    <div>
                                        <p className="text-indigo-300 text-sm font-medium uppercase leading-4">Clients</p>
                            ...
                            <div className="bg-black/30 p-6 rounded-lg">
                                <div className="flex flex-row space-x-4 items-center">
                                    ...
                                    <div>
                                        <p className="text-teal-300 text-sm font-medium uppercase leading-4">Payments</p>
                                        <p className="text-white font-bold text-2xl inline-flex items-center space-x-2">
                                            <span>PKR 2.3M</span>
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className="hero min-h-screen bg-black/30 rounded-lg mt-6">
                        <div className="hero-content text-center">
                            <div className="max-w-md">
                            <h1 className="text-5xl font-bold">LandLine Analytics</h1>
                            <p className="py-6">Want to see real-time data analysis and market insights in order to make well-informed decisions? Subscribe to our premium service now for just PKR 1199/mo.</p>
